...
$total_reg = @count($res);
    if($total_reg == 0){
        $res = $pdo->query("INSERT INTO oficina.usuarios SET nome = 'Administrador', cpf = '000.000.000-00', email = '$email_adm', senha = '123', nivel = 'admin'");   
    }
        ...
        <form method="post" action="autenticar.php">
            ...
            <div align="center" class="mt-2">
                <small><a href="" data-toggle="modal" data-target="#modalRecuperar"
                        title="Clique para Recuperar sua Senha" class="text-light">Recuperar Senha?</a></small>
            </div>
        </form>
    </div>
